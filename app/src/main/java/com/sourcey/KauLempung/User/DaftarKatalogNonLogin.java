...
import com.sourcey.KauLempung.Adapter.ProdukAdapterNonCheck;
...
public class DaftarKatalogNonLogin extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    ProdukAdapterNonCheck katalogAdapter;
        ...
        if (user == null) {
            ...
            tvFilter.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    startActivity(new Intent(DaftarKatalogNonLogin.this, FilterActivity.class));
                }
            });
...
//            idUser = user.getEmail();
            ...
            list = new ArrayList<>();
            mList = new ArrayList<>();
            katalogAdapter = new ProdukAdapterNonCheck(this,list);
            ...
            Intent pindah = new Intent(DaftarKatalogNonLogin.this,LoginActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            mAuth.signOut();
            startActivity(new Intent(DaftarKatalogNonLogin.this, LoginActivity.class));
            finish();
        } else if (id == R.id.action_profile){
            startActivity(new Intent(DaftarKatalogNonLogin.this, ProfilUser.class));
            finish();
        }
